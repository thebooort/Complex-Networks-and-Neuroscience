...
ant_image_filename = "blue-dot.png"
ITERATIONS = 10
...
def run():
    ...
    pygame.init()
    pygame.display.set_caption('hormigas langton')
    ...
    font = pygame.font.SysFont(default_font, 10)    
    ...
    while True:
        ...
        grid.render(screen, ((0, 0, 0), (255, 255, 255)), GRID_SQUARE_SIZE)
        ...
        txt = "%i"%total_iterations
        txt_surface = font.render(" %i "%total_iterations, True, (120, 120,120))
